      ...
      e: for (var H = 0, Y = C.length, er = Y >>> 1; H < er; ) {
        ...
        if (0 > l(Sl, z))
          gn < Y && 0 > l(nr, Sl)
            ? ((C[H] = nr), (C[gn] = z), (H = gn))
            : ((C[H] = Sl), (C[yn] = z), (H = yn));
        else if (gn < Y && 0 > l(nr, z)) (C[H] = nr), (C[gn] = z), (H = gn);
        else break e;
      }
    }
    return P;
    ...
    (e.unstable_scheduleCallback = function (C, P, z) {
      ...
      return (
        ...
        z > H
          ...
          : ((C.sortIndex = Y), n(s, C), w || g || ((w = !0), gl(E))),
        C
      );
    }),
...
var Qe = !(
  ...
  Sc = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,
  $u = {},
  Au = {};
function kc(e) {
  return Yl.call(Au, e)
...
function hs() {
  if (Gn) {
    var e = Gn,
      n = Yn;
    if (((Yn = Gn = null), Ku(e), n)) for (e = 0; e < n.length; e++) Ku(n[e]);
  }
}
function vs(e, n) {
  return e(n);
...
function nu(e, n, t, r) {
  if (Fr) {
    var l = po(e, n, t, r);
    if (l === null) Fl(e, n, r, jr, t), Xu(e, r);
...
var jr = null;
function po(e, n, t, r) {
  if (((jr = null), (e = Jo(r)), (e = kn(e)), e !== null))
...
var Sf = Qe && "TextEvent" in window && !xt,
  Is = Qe && (!ou || (xt && 8 < xt && 11 >= xt)),
...
function $s(e) {
  if (e.propertyName === "value" && rl(Ut)) {
    var n = [];
    js(n, Ut, e, Jo(e)), gs(_f, n);
  }
}
function Nf(e, n, t) {
  e === "focusin"
    ? (oi(), (Nt = n), (Ut = t), Nt.attachEvent("onpropertychange", $s))
    : e === "focusout" && oi();
}
function Pf(e) {
...
var Et = "abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(
  ...
  Df = new Set("cancel close invalid load scroll toggle".split(" ").concat(Et));
function ci(e, n, t) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = It(a, f)), v != null && S.push(Vt(a, v, d)))),
            F)
          )
            break;
          a = a.return;
...
function fi(e, n, t, r, l) {
  for (var o = n._reactName, u = []; t !== null && t !== r; ) {
    ...
    i.tag === 5 &&
      ...
      ((i = c),
      l
        ? ((s = It(t, o)), s != null && u.unshift(Vt(t, s, i)))
        : l || ((s = It(t, o)), s != null && u.push(Vt(t, s, i)))),
      (t = t.return);
  }
...
function vn() {
  if (!Ul && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), Es(qo, vn), l);
    } finally {
      (O = n), (Ul = !1);
    }
  }
...
function No(e, n, t, r) {
  ...
  typeof o == "object" && o !== null
    ? (l.context = _e(o))
    : ((o = de(n) ? Nn : re.current), (l.context = et(e, o))),
...
function aa(e, n) {
  ...
  if (
    ...
    if (
      ((t.flags |= 2048),
      Gt(9, fa.bind(null, t, r, l, n), void 0, null),
      Z === null)
    )
      throw Error(y(349));
    (zn & 30) !== 0 || ca(t, n, l);
  ...
  Xf = {
    ...
    useSyncExternalStore: function (e, n, t) {
      ...
      return (
        ...
        (r.flags |= 2048),
        Gt(9, fa.bind(null, r, o, t, n), void 0, null),
        t
      );
    },
    useId: function () {
...
function Ri(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    Pr(e, n), la(n, t, r), No(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
...
function Oi(e, n, t, r, l) {
  return nt(), au(l), (n.flags |= 256), le(e, n, t, r), n.child;
}
  ...
  if (t)
    return n.flags & 256
      ...
      : ((o = r.fallback),
        ...
        (r.sibling = o),
        (n.child = r),
        (n.mode & 1) !== 0 && tt(n, e.child, null, u),
...
function td(e, n, t) {
  ...
  switch ((su(n), n.tag)) {
    ...
    case 4:
      return (
        rt(), Oo(e, n), e === null && At(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[Bt], delete n[So], delete n[Vf], delete n[Bf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = wo(Sn.bind(null, e, ae, Ae), n);
            break;
          }
          Sn(e, ae, Ae);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = wo(Sn.bind(null, e, ae, Ae), r);
            break;
          }
          Sn(e, ae, Ae);
          break;
...
function dd(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    Z === e &&
      (q & t) === t &&
      (G === 4 || (G === 3 && (q & 130023424) === q && 500 > W() - Nu)
        ? _n(e, 0)
        : (xu |= t)),
    pe(e, n);
}
function Ya(e, n) {
  ...
  var t = ue();
  (e = Ge(e, n)), e !== null && (Zt(e, n, t), pe(e, t));
}
function pd(e) {
  var n = e.memoizedState,
    t = 0;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (bo(n, t | 1), pe(n, W()), (R & 6) === 0 && ((ot = W() + 500), vn()));
      }
      break;
    case 13:
      Tn(function () {
...
vs = Pu;
ys = Tn;
var kd = { usingClientEntryPoint: !1, Events: [qt, $n, ol, ms, hs, Pu] },
  gt = {
...
var Wi = qi.exports;
(Gl.createRoot = Wi.createRoot), (Gl.hydrateRoot = Wi.hydrateRoot);
var vl = { exports: {} },
  yl = {};
/**
 * @license React
...
const nc = vl.exports.Fragment,
  oe = vl.exports.jsx,
  qn = vl.exports.jsxs,
  Ld = ({ onAddCategory: e, categories: n }) => {
    const [t, r] = je.exports.useState("");
    return oe("form", {
      onSubmit: (u) => {
        u.preventDefault();
        const i = t.trim();
  ...
  Td = ({ id: e, title: n, url: t }) =>
    qn(
      "div",
      {
        className: "card",
        children: [
          oe("h4", { className: "text-white font-weight-light", children: n }),
          oe("img", { src: t, alt: n }),
        ],
      },
      e
  ...
  Rd = async (e) => {
    const t = `https://api.giphy.com/v1/gifs/search?api_key=AhV9WN4q7ny59eg8vw0lQrvFGDbLAkgt&q=${e}&limit=5`,
      r = await fetch(t),
      { data: l = [] } = await r.json();
    return l.map((o) => ({
      id: o.id,
  ...
  Od = (e) => {
    const [n, t] = je.exports.useState([]),
      [r, l] = je.exports.useState(!0),
      o = async () => {
        const u = await Rd(e);
        setTimeout(() => {
          t(u), l(!1);
  ...
  Md = "./assets/loader.b360359f.gif",
  Id = ({ category: e }) => {
    const { gifs: n, isLoading: t } = Od(e);
    return oe(nc, {
      children: qn("section", {
        children: [
          oe("h2", {
            className: "text-center text-capitalize text-muted",
            children: e,
          }),
          t &&
            oe("img", {
  ...
  Dd = ({ gifs: e }) =>
    oe("section", {
      className: "card-grid",
      children: e.map((n) => je.exports.createElement(Td, { ...n, key: n.id })),
    }),
  Fd = () => {
    const [e, n] = je.exports.useState([]);
    return oe(nc, {
      children: qn("div", {
        className: "container",
        children: [
          qn("header", {
            ...
            children: [
              oe("h1", {
                ...
                children: "Gif Search App",
              }),
              oe(Ld, {
                onAddCategory: (r) => {
                  e.find((l) => l.toLowerCase() === r.toLowerCase()) ||
                    n([...e, r]);
                },
                categories: e,
              }),
          ...
          e.map((r) => oe(Id, { category: r }, r)),
        ],
      }),
    });
  };
Gl.createRoot(document.getElementById("root")).render(
  oe(wc.StrictMode, { children: oe(Fd, {}) })
);
